...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=2]
        ...
        \draw[->] (O) ++(0.5,0) arc (0:-\coordRot:0.5) node[right, midway]{\yawAngle};
        ...
        \def\coordDistance{1.5}
         ...
         \draw[->] (O) ++(0.5,0) arc (0:\coordRot:0.5) node[right, midway]{\pitchAngle};
        ...
        \draw[->] (O) ++(-0.5,0) arc (180:180+\coordRot:0.5) node[left, midway]{\rollAngle};
