...
\begin{tikzpicture}
    ...
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
        ...
        \draw[red, thick] (O) ++(0.34,0.23) node[right]{Thruster 1};
        \draw[yellow, thick, <->] (O) ++(0.34,0) -- ++(0,-0.28) node [midway, left] {\distance{y}{2}};
        \draw[red, thick] (O) ++(0.34,-0.28) node[right]{Thruster 2};
        \draw[yellow, thick, <->] (O) ++(0.03,0) -- ++(0,0.24)  node [midway, right] {\distance{y}{3}};
        \draw[red, thick] (O) ++(0.03,0.24) node[right]{Thruster 3};
        \draw[yellow, thick, <->] (O) ++(0.03,0) -- ++(0,-0.28) node [midway, right] {\distance{y}{4}};
        \draw[red, thick] (O) ++(0.03,-0.28) node[right]{Thruster 4};
        
        \draw[yellow, thick, <->] (O) ++(0,0.27) -- ++(0.34,0)  node [midway, above] {\distance{x}{1}};
        ...
        \draw[red, thick] (O) ++(-0.35,0) node[below]{Thruster 5};
    \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
    ...
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
        ...
        \draw[red, thick,->] (O) ++(-\coordinateRadius,0) -- ++(-0.4,0) node[anchor=north east]{\color{red}$\yPosition$};
        \draw[red, thick,->] (O) ++(0,-\coordinateRadius)-- ++(0,-0.5) node[anchor=south east]{\color{red}$\zPosition$};
        \draw[red, thick] (O) circle (\coordinateRadius) node[anchor=south,]{\color{red}$\xPosition$};
		\draw[red,thick] (O) node[circle,fill,inner sep=1pt]{};
        
        \draw[yellow, thick, <->] (O) ++(0.04,0) -- ++(0,-0.37)  node [midway, right]{\distance{z}{6}};
        \draw[red, thick] (O) ++(0.04,-0.37) node[right]{Thruster 6};
    \end{scope}
\end{tikzpicture}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Kinetics} \index{Kinetics}\index{Transformation matrices}\label{sec:kinetics}
