...
\section{Hydrodynamics} \index{Hydrodynamics} 
...
\begin{split}
    ...
    \end{bmatrix},
\end{split}
\end{equation} under the assumption that the \abbrROV is moving slowly and has three planes of symmetry \citep[p. 121]{fossen2011}. \index{Coriolis} \index{Damping}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Actuators}  \index{Look-up table} \index{Actuators}
