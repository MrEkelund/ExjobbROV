...
\begin{tikzpicture}
    ...
    \end{scope}
\end{tikzpicture}
    \caption{Front view of the \abbrROV. The body-fixed coordinate system (red) is fixed in the \abbrROV. The yellow line show the moment arm to thruster 6 which is marked in red.}
