...
\todo[inline]{Bilden av hur saker ar kopplade ar inte fixad. Utan den gors senare.}
\section{BlueROV Package}
\Figureref{fig:rov} shows the BlueRov from BlueRobotics used in this thesis. The BlueROV package includes an acrylic chassi, an acrylic tube, six electronic speed controllers, six BlueRobotics T200 thrusters, cable penetrators and a cradle for mounting of electronics.
\begin{figure}
\centering
