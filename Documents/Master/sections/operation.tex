...
\begin{tikzpicture}
    ...
    \end{scope}
\end{tikzpicture}
\caption{The \abbrIC port where the pressure sensor ought to be connected is circled in red. Note that the HkPilot has to be soldered for enabling the red circled \abbrIC port.}
\label{fig:i2c}
\end{figure}
...
\todo{This i no longer up-to date}
