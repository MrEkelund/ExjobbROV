...
\begin{figure}[htbp]
  ...
  \qquad
  \subfloat[][\label{fig:q_rTest}Excitation in $q$ during $r$ test.]{\includegraphics[width=0.4\textwidth]{q_r_test}}  | 848 ++++++++++++++-----------------------------------------------------------------------------------------
 Documents/texmf/tex/latex/rtphd-defs.sty                  
  \\
...
\end{equation*}
Five data sets were feed in to the estimator, while the fourth and fifth were used as validation data. All data sets were of excitations in $p$, $q$ and $r$ simultaneously. Parameter values from the estimation can be viewed together with the initial states in \tableref{tab:ResultKalmanFixedMomentArms}. \todo[inline]{fortsätt här!!!!!!!!!!}
\begin{table}[hbp]
  \centering
