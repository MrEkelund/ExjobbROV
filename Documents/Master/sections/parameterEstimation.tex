...
\begin{figure}[htbp]
  \centering
  \subfloat[][\label{fig:p_pqTest}$p$.]{\includegraphics[width=0.7\textwidth]{p_pq_test}}
  \qquad
  \subfloat[][\label{fig:q_pqTest}$q$.]{\includegraphics[width=0.7\textwidth]{q_pq_test}}
  \\
  \subfloat[][\label{fig:r_pqTest}$r$.]{\includegraphics[width=0.7\textwidth]{r_pq_test}}
...
\begin{figure}[htbp]
  \centering
  \subfloat[][\label{fig:p_rTest}$p$.]{\includegraphics[width=0.7\textwidth]{p_r_test}}
  \qquad
  \subfloat[][\label{fig:q_rTest}$q$.]{\includegraphics[width=0.7\textwidth]{q_r_test}}
  \\
  \subfloat[][\label{fig:r_rTest}$r$.]{\includegraphics[width=0.7\textwidth]{r_r_test}}
