...
\end{equation*}
The estimation was done with three data sets of which the first two were used for estimation and the third for validation. The estimator was also iterated five times, using the parameter values from the previous estimation as the new initial states. The resulting parameter values and their initial values can be viewed in \tableref{tab:ResultKalmanFixedMomentArmsLz6} and a comparison against validation data is shown in \figureref{fig:ResultKalmanFixedMomentArmsLz6}
