...
A \abbrEKF was also used to estimate parameters of the \abbrROV. The reparameteriesed model from \Sectionref{sec:estimation_angular} was used to model $\eta$ and $\nu$. Measurement equations were taken from \Chapterref{cha:fusion}. Each model parameter was modelled as a state using a constant position motion model. The entire motion model used in the filter was discretised using the Euler forward discretisation method. The complete discrete model used was
\begin{equation}
