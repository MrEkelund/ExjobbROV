...
\begin{column}{0.5\textwidth}
\begin{itemize}
\item \structure<1-2> {Vad är parameterskattning?}
...
\begin{columns}
	...
	\end{column}
\end{columns}
\note{Blå sensorfusion, rött integrerat}
\end{frame}
...
\begin{columns}
	...
	\begin{itemize}
	\item \structure<1> {Skattningsstruktur}
	\item \structure<2> {Initialtillståndsskattning}
	\end{itemize}
	\end{column}
...
\item Enkelt att implementera och testa nya regulatorer
\end{itemize}
\end{frame}
%%%%%%%%%%%%
