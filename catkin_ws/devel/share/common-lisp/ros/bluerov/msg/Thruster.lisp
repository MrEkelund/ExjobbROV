...
(cl:defmethod cl:initialize-instance :after ((m <Thruster>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Thruster)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bluerov-msg:<Thruster> is deprecated: use bluerov-msg:Thruster instead.")))
...
(cl:defmethod commands-val ((m <Thruster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bluerov-msg:commands-val is deprecated.  Use bluerov-msg:commands instead.")
  (commands m))
