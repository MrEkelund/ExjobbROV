...
typedef struct {
  real_T thruster1;                    // '<S3>/MATLAB Function'
  real_T thruster2;                    // '<S3>/MATLAB Function'
  real_T thruster3;                    // '<S3>/MATLAB Function'
  real_T thruster4;                    // '<S3>/MATLAB Function'
  real_T thruster5;                    // '<S3>/MATLAB Function'
  real_T thruster6;                    // '<S3>/MATLAB Function'
...
typedef struct {
  uint8_T is_active_c6_Controller_without;// '<S15>/State Transition Table'
  uint8_T is_c6_Controller_without_ref;// '<S15>/State Transition Table'
} rtDW_StateTransitionTable_Con_T;

// Block signals (auto storage)
typedef struct {
  SL_Bus_Controller_without_ref_std_msgs_Float64MultiArray In1;// '<S58>/In1'
  SL_Bus_Controller_without_ref_std_msgs_Float64MultiArray varargout_2;
  SL_Bus_Controller_without_ref_std_msgs_UInt16MultiArray msg;// '<S12>/PWM assign' 
  real_T state[35];
  real_T ctheta[9];
  real_T dv0[9];
  real_T b_x[9];
  SL_Bus_Controller_without_ref_geometry_msgs_Twist In1_m;// '<S33>/In1'
  ...
  rtB_MATLABFunction_Controll_n_T sf_MATLABFunction_io;// '<S20>/MATLAB Function' 
  ...
  rtB_MATLABFunction_Controller_T sf_MATLABFunction;// '<S4>/MATLAB Function'
  rtB_MATLABFunction_Controller_T sf_MATLABFunction_i;// '<S3>/MATLAB Function'
} BlockIO_Controller_without_re_T;

// Block states (auto storage) for system '<Root>'
typedef struct {
  robotics_slros_internal_block_T obj; // '<S56>/P_vel_z'
  robotics_slros_internal_block_T obj_a;// '<S56>/D_vel_z'
  robotics_slros_internal_block_T obj_h;// '<S56>/N_vel_z '
  robotics_slros_internal_block_T obj_j;// '<S56>/I_vel_z'
  robotics_slros_internal_block_T obj_ji;// '<S53>/P_vel_y'
  robotics_slros_internal_block_T obj_n;// '<S53>/D_vel_y'
  robotics_slros_internal_block_T obj_c;// '<S53>/N_vel_y '
  ...
  robotics_slros_internal_block_T obj_l;// '<S41>/N_angular_vel_x '
  ...
  robotics_slros_internal_block_T obj_mp;// '<S4>/Get front strafe decouple'
  robotics_slros_internal_block_T obj_ij;// '<S4>/Get front forward decouple'
  robotics_slros_internal_block_T obj_nr;// '<S4>/Get front pitch bias'
  robotics_slros_internal_block_T obj_o5;// '<S4>/Get front vertical bias'
  robotics_slros_internal_block_T obj_ot;// '<S4>/Get buoyancy'
  robotics_slros_internal_block_T obj_np;// '<S3>/Get front strafe decouple'
  robotics_slros_internal_block_T obj_dti;// '<S3>/Get front forward decouple'
  robotics_slros_internal_block_T obj_cp;// '<S3>/Get front pitch bias'
  robotics_slros_internal_block_T obj_ci;// '<S3>/Get front vertical bias'
  robotics_slros_internal_block_T obj_ae;// '<S3>/Get buoyancy'
  ...
  void *SinkBlock_PWORK;               // '<S63>/SinkBlock'
  ...
  void *Getfrontstrafedecouple_PWORK;  // '<S4>/Get front strafe decouple'
  void *Getfrontforwarddecouple_PWORK; // '<S4>/Get front forward decouple'
  void *Getfrontpitchbias_PWORK;       // '<S4>/Get front pitch bias'
  void *Getfrontverticalbias_PWORK;    // '<S4>/Get front vertical bias'
  void *Getbuoyancy_PWORK;             // '<S4>/Get buoyancy'
  void *Getfrontstrafedecouple_PWORK_e;// '<S3>/Get front strafe decouple'
  void *Getfrontforwarddecouple_PWORK_f;// '<S3>/Get front forward decouple'
  void *Getfrontpitchbias_PWORK_c;     // '<S3>/Get front pitch bias'
  void *Getfrontverticalbias_PWORK_p;  // '<S3>/Get front vertical bias'
  void *Getbuoyancy_PWORK_n;           // '<S3>/Get buoyancy'
  ...
  robotics_slros_internal_blo_o_T obj_k;// '<S10>/SourceBlock'
  robotics_slros_internal_blo_o_T obj_nf;// '<S8>/SourceBlock'
  robotics_slros_internal_bl_oe_T obj_pw;// '<S63>/SinkBlock'
  boolean_T objisempty;                // '<S63>/SinkBlock'
  boolean_T objisempty_i;              // '<S10>/SourceBlock'
  boolean_T objisempty_l;              // '<S56>/P_vel_z'
  boolean_T objisempty_n;              // '<S56>/D_vel_z'
  boolean_T objisempty_e;              // '<S56>/N_vel_z '
  boolean_T objisempty_n4;             // '<S56>/I_vel_z'
  ...
  boolean_T objisempty_a3;             // '<S18>/Swtiching factor'
  ...
  boolean_T objisempty_gp;             // '<S4>/Get front strafe decouple'
  boolean_T objisempty_do;             // '<S4>/Get front forward decouple'
  boolean_T objisempty_gx;             // '<S4>/Get front pitch bias'
  boolean_T objisempty_o0;             // '<S4>/Get front vertical bias'
  boolean_T objisempty_bn;             // '<S4>/Get buoyancy'
  boolean_T objisempty_gg;             // '<S3>/Get front strafe decouple'
  boolean_T objisempty_ol;             // '<S3>/Get front forward decouple'
  boolean_T objisempty_ds;             // '<S3>/Get front pitch bias'
  boolean_T objisempty_ml;             // '<S3>/Get front vertical bias'
  boolean_T objisempty_mt;             // '<S3>/Get buoyancy'
...
struct Parameters_Controller_without_T_ {
  ...
  SL_Bus_Controller_without_ref_std_msgs_Float64MultiArray Out1_Y0;// Computed Parameter: Out1_Y0
                                                                   //  Referenced by: '<S58>/Out1'

  SL_Bus_Controller_without_ref_std_msgs_Float64MultiArray Constant_Value;// Computed Parameter: Constant_Value
  ...
  real_T Getbuoyancy_SampleTime_e;     // Expression: SampleTime
                                       //  Referenced by: '<S4>/Get buoyancy'

  real_T Getfrontverticalbias_SampleTi_e;// Expression: SampleTime
                                         //  Referenced by: '<S4>/Get front vertical bias'

  real_T Getfrontpitchbias_SampleTime_n;// Expression: SampleTime
                                        //  Referenced by: '<S4>/Get front pitch bias'

  real_T Getfrontforwarddecouple_Sampl_h;// Expression: SampleTime
                                         //  Referenced by: '<S4>/Get front forward decouple'

  real_T Getfrontstrafedecouple_Sample_b;// Expression: SampleTime
...
class ControllerModelClass {
 ...
 private:
  ...
  void Controller_without__RandSrc_U_D(real_T y[], const real_T minVec[],
...
//  '<S1>'   : 'Controller_without_ref/Compare To Constant'
//  '<S2>'   : 'Controller_without_ref/Create errors'
//  '<S3>'   : 'Controller_without_ref/Decouple1'
//  '<S4>'   : 'Controller_without_ref/Decouple2'
//  '<S5>'   : 'Controller_without_ref/Telegraph'
//  '<S6>'   : 'Controller_without_ref/Xbox_input'
//  '<S7>'   : 'Controller_without_ref/acc integration'
//  '<S8>'   : 'Controller_without_ref/cmd_vel'
//  '<S9>'   : 'Controller_without_ref/decController'
//  '<S10>'  : 'Controller_without_ref/imu_data'
//  '<S11>'  : 'Controller_without_ref/states'
//  '<S12>'  : 'Controller_without_ref/toPWM'
//  '<S13>'  : 'Controller_without_ref/Decouple1/MATLAB Function'
//  '<S14>'  : 'Controller_without_ref/Decouple2/MATLAB Function'
//  '<S15>'  : 'Controller_without_ref/Telegraph/Thruster1 block'
//  '<S16>'  : 'Controller_without_ref/Telegraph/Thruster2 block'
//  '<S17>'  : 'Controller_without_ref/Telegraph/Thruster3 block'
//  '<S18>'  : 'Controller_without_ref/Telegraph/Thruster4 block'
//  '<S19>'  : 'Controller_without_ref/Telegraph/Thruster5 block '
//  '<S20>'  : 'Controller_without_ref/Telegraph/Thruster6 block'
//  '<S21>'  : 'Controller_without_ref/Telegraph/Thruster1 block/MATLAB Function'
//  '<S22>'  : 'Controller_without_ref/Telegraph/Thruster1 block/State Transition Table'
//  '<S23>'  : 'Controller_without_ref/Telegraph/Thruster2 block/MATLAB Function'
//  '<S24>'  : 'Controller_without_ref/Telegraph/Thruster2 block/State Transition Table'
//  '<S25>'  : 'Controller_without_ref/Telegraph/Thruster3 block/MATLAB Function'
//  '<S26>'  : 'Controller_without_ref/Telegraph/Thruster3 block/State Transition Table'
//  '<S27>'  : 'Controller_without_ref/Telegraph/Thruster4 block/MATLAB Function'
//  '<S28>'  : 'Controller_without_ref/Telegraph/Thruster4 block/State Transition Table'
//  '<S29>'  : 'Controller_without_ref/Telegraph/Thruster5 block /MATLAB Function'
//  '<S30>'  : 'Controller_without_ref/Telegraph/Thruster5 block /State Transition Table'
//  '<S31>'  : 'Controller_without_ref/Telegraph/Thruster6 block/MATLAB Function'
//  '<S32>'  : 'Controller_without_ref/Telegraph/Thruster6 block/State Transition Table'
//  '<S33>'  : 'Controller_without_ref/cmd_vel/Enabled Subsystem'
//  '<S34>'  : 'Controller_without_ref/decController/angular_vel x'
//  '<S35>'  : 'Controller_without_ref/decController/angular_vel y'
//  '<S36>'  : 'Controller_without_ref/decController/angular_vel z'
//  '<S37>'  : 'Controller_without_ref/decController/vel x'
//  '<S38>'  : 'Controller_without_ref/decController/vel y'
//  '<S39>'  : 'Controller_without_ref/decController/vel z'
//  '<S40>'  : 'Controller_without_ref/decController/angular_vel x/PID Controller'
//  '<S41>'  : 'Controller_without_ref/decController/angular_vel x/Retrive PID-Parameters'
//  '<S42>'  : 'Controller_without_ref/decController/angular_vel x/PID Controller/Clamping circuit'
//  '<S43>'  : 'Controller_without_ref/decController/angular_vel y/PID Controller'
//  '<S44>'  : 'Controller_without_ref/decController/angular_vel y/Retrive PID-Parameters'
//  '<S45>'  : 'Controller_without_ref/decController/angular_vel y/PID Controller/Clamping circuit'
//  '<S46>'  : 'Controller_without_ref/decController/angular_vel z/PID Controller'
//  '<S47>'  : 'Controller_without_ref/decController/angular_vel z/Retrive PID-Parameters'
//  '<S48>'  : 'Controller_without_ref/decController/angular_vel z/PID Controller/Clamping circuit'
//  '<S49>'  : 'Controller_without_ref/decController/vel x/PID Controller'
//  '<S50>'  : 'Controller_without_ref/decController/vel x/Retrive PID-Parameters'
//  '<S51>'  : 'Controller_without_ref/decController/vel x/PID Controller/Clamping circuit'
//  '<S52>'  : 'Controller_without_ref/decController/vel y/PID Controller'
//  '<S53>'  : 'Controller_without_ref/decController/vel y/Retrive PID-Parameters'
//  '<S54>'  : 'Controller_without_ref/decController/vel y/PID Controller/Clamping circuit'
//  '<S55>'  : 'Controller_without_ref/decController/vel z/PID Controller'
//  '<S56>'  : 'Controller_without_ref/decController/vel z/Retrive PID-Parameters'
//  '<S57>'  : 'Controller_without_ref/decController/vel z/PID Controller/Clamping circuit'
//  '<S58>'  : 'Controller_without_ref/imu_data/Enabled Subsystem'
//  '<S59>'  : 'Controller_without_ref/states/removeGravity'
//  '<S60>'  : 'Controller_without_ref/toPWM/Actuator message '
//  '<S61>'  : 'Controller_without_ref/toPWM/Calc pwm signal'
//  '<S62>'  : 'Controller_without_ref/toPWM/PWM assign'
//  '<S63>'  : 'Controller_without_ref/toPWM/Publish'
