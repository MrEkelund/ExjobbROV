...
private:
  ...
  Eigen::Matrix<double, 8, 1> initial_states;
  Eigen::Matrix<double, 8, 1> states;
  Eigen::Matrix<double, 8, 1> new_states;
  // covariance of states
  Eigen::Matrix<double, 8, 8> initial_state_cov;
  Eigen::Matrix<double, 8, 8> state_cov;
  Eigen::Matrix<double, 8, 8> new_state_cov;

  Eigen::Matrix<double, 8, 8> F; // motion model
  Eigen::Matrix<double, 8, 4> Gv; // noise propagation
  Eigen::Matrix<double, 4, 4> process_cov; //covariance for motion model

//matrices for gyro measurement update
  Eigen::Matrix<double, 3, 8> H_gyro;
  Eigen::Matrix<double, 3, 1> h_gyro;
  Eigen::Matrix<double, 3, 3> cov_gyro;

//matrices for acc measurement update
  Eigen::Matrix<double, 3, 8> H_acc;
  Eigen::Matrix<double, 3, 1> h_acc;
  Eigen::Matrix<double, 3, 3> cov_acc;

//matrices for magnetometer measurement update
  Eigen::Matrix<double, 3, 8> H_mag;
...
//matrices for pressure measurement update
  Eigen::Matrix<double, 1, 8> H_pressure;
