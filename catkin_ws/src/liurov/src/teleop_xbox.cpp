/*
 * File: liurov/src/teleop_xbox.cpp
 * Author: Erik Ekelund, based on code from Bluerobotics blurovpkg
 * Date: Jan 2016
 * Description: Sends thruster commands in microseconds to the liurov.
 */


#include <teleop_xbox.h>

TeleopXbox::TeleopXbox() {
  // connect dynamic reconfigure
  dynamic_reconfigure::Server<liurov::teleop_xboxConfig>::CallbackType f;
