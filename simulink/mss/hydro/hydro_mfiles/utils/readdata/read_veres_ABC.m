...
vessel.MRB = Tmtrx*MRB*Tmtrx;  % MRB transformed from veres to fossen axes
...
for k = 1:nvel,
    for i = 1:nfreq,
        vessel.A(:,:,i,k) = Tmtrx*Amtrx2(:,:,i,k)*Tmtrx;  
        vessel.B(:,:,i,k) = Tmtrx*Bmtrx2(:,:,i,k)*Tmtrx;  
        vessel.C(:,:,i,k) = Tmtrx*Cmtrx2(:,:,i,k)*Tmtrx; 
