...
%         data.OutputUnit = {'rad/s','rad'};
    case 'All'
        ...
        data.InputUnit =  {'%','%','%','%','%','%'};
        data.OutputName = {'p', 'q', 'r', 'an', 'ae', 'ad', 'mn', 'me', 'md'};
...
Ts_model = 1/resampling_fs;      % Sample time [s].
...
parameters = [parameters; Ts_model; temp_exp.OutputData(1,[7 8 9])'];
parameter_strings{end+1} = 'Ts';
